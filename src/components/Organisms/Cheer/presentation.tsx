...
export const Cheer: React.FC = React.memo(() => {
	...
	const setHeightOnList = () => {
		const targetLists = Array.from(
			document.querySelectorAll('[data-js=cheer_list]'),
		) as HTMLElement[];
		...
		<ApplicationLayout>
			<section className={styles.cheer}>
				<div className={styles.cheer__head}>
					<h2 className={styles.cheer__title}>がんばりスト</h2>
					<div>
						<button type="button" className={styles.cheer__button}></button>
					</div>
				</div>
					...
					<div className={styles.wrapper__inner}>
						<div className={styles.container}>
							<div className={styles.container__inner}>
								...
								<div className={styles.container__list} data-js="cheer_list">
									<ul
